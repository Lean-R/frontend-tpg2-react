  ...
  return (
    <nav className={styles.os_navbar}>
      ...
      <ul className={styles.nav_links} id="nav-menu">
        <li>
          <HashLink to="index.html#runtime">RUNTIME</HashLink>
        </li>
        <li>
          <HashLink to="index.html#brew">BREW_DOCS</HashLink>
        </li>
        <li>
          <HashLink to="index.html#source">SOURCE</HashLink>
        </li>
        <li>
          <HashLink to="index.html#terminal">TERMINAL</HashLink>
        </li>
        <li>
      ...
      <div className={styles.nav_system_icons}>
        ...
        <span className={styles.nav_time} id="current-time">
          00:00:00 AM
        </span>
